...
INSERT INTO `__efmigrationshistory` VALUES ('20180418022502_CreateIdentitySchema','2.0.2-rtm-10011'),('20180519205146_AdjustAlert_Identifier','2.0.2-rtm-10011'),('20180529193534_AddAlert_Identifier','2.0.2-rtm-10011'),('20180529230712_AddAlert_Identifier','2.0.2-rtm-10011'),('20180625161116_RollbackAdjustments','2.0.2-rtm-10011'),('20180718172519_20180718_MasterBranchUpdate','2.0.2-rtm-10011'),('20180718175140_Empty_Test','2.0.2-rtm-10011'),('20180806205131_Adjustment','2.0.2-rtm-10011'),('20180824181542_SelectedAlertIdentifier','2.0.2-rtm-10011'),('20180903201514_CompleteCategories','2.0.2-rtm-10011'),('20180903212403_InfoEdit','2.0.2-rtm-10011');
...
INSERT INTO `area` VALUES (1,'NULL','CAZ107; CAZ108','NULL','NULL',3,'FIPS6, , UGC, CAZ107, UGC, CAZ108','39.99, -122.90 39.99, -123.54 40.80, -123.56 40.92, -123.60 40.92, -123.49 41.05, -123.41 41.09, -123.47 41.17, -123.40 41.13, -123.29 40.99, -122.94 41.08, -122.74 40.57, -123.95 41.33, -122.53 41.10, -122.46 40.70, -122.74 40.57, -122.71 40.36, -123.02 39.99, -122.90','NOAA-NWS-ALERTS-CA125838fsecfc.WinterStormWarning.125838f803c0CA.EKAWSWEKA.d2e18d2b81b08f7bcd9e6fadde0ff6db'),(2,'NULL','Mono','NULL','NULL',3,'FIPS6,006051,UGC,CAZ073 ','NULL','NOAA-NWS-ALERTS-CA125A9F5E174C.WinterWeatherAdvisory.125AA39AAE60CA.REVWSWREV.58c9bead01ca6732bc88705059f76f46'),(3,'NULL','Lower Kuskokwim Valley','NULL','NULL',3,'FIPS6,002050,UGC,AKZ152','61.53,-159.4 61.5,-159.81 61.6,-159.81 61.62,-159.4 61.53,-159.4','NOAA-NWS-ALERTS-AK125AA3AA1EB8.FloodAdvisory.125AA3B95FCCAK.AFCFLSAFC.026e2b11e582dbb6bd863dfa37b89739');
...
CREATE TABLE `edxlcapmessageviewmodel` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_EdxlCapMessageViewModel_AlertIndex` (`AlertIndex`),
  KEY `IX_EdxlCapMessageViewModel_AreaIndex` (`AreaIndex`),
  KEY `IX_EdxlCapMessageViewModel_InfoIndex` (`InfoIndex`),
  KEY `IX_EdxlCapMessageViewModel_ResourceIndex` (`ResourceIndex`),
  CONSTRAINT `FK_EdxlCapMessageViewModel_AlertIndex` FOREIGN KEY (`AlertIndex`) REFERENCES `alert` (`AlertIndex`),
  CONSTRAINT `FK_EdxlCapMessageViewModel_Alert_AlertIndex` FOREIGN KEY (`AlertIndex`) REFERENCES `alert` (`AlertIndex`),
...
INSERT INTO `edxlcapmsg` VALUES (1,'\'NOAA-NWS-ALERTS-CA125838fsecfc.WinterStormWarning.125838f803c0CA.EKAWSWEKA.d2e18d2b81b08f7bcd9e6fadde0ff6db\'',1,1,1,1,1,1,NULL,NULL,NULL,NULL),(2,'\'NOAA-NWS-ALERTS-CA125A9F5E174C.WinterWeatherAdvisory.125AA39AAE60CA.REVWSWREV.58c9bead01ca6732bc88705059f76f46\'',2,2,2,2,2,2,NULL,NULL,NULL,NULL),(3,'\'NOAA-NWS-ALERTS-AK125AA3AA1EB8.FloodAdvisory.125AA3B95FCCAK.AFCFLSAFC.026e2b11e582dbb6bd863dfa37b89739\'',3,3,3,3,3,3,NULL,NULL,NULL,NULL);
...
INSERT INTO `identityuser<string>` VALUES ('16410cda-9e6c-4833-b5f7-fd0596e03b05',0,'4e601dce-3ec4-443d-9442-292b46c4746c','ApplicationUser','rexbroo@gmail.com','\0','',NULL,'REXBROO@GMAIL.COM','REXBROO@GMAIL.COM','AQAAAAEAACcQAAAAEAwkKXWTj/RCoWk2sD5OQl8AAtoFRjYlGF3OfH7yDEosBCwRTBmfRA6e5lggmJJXMw==',NULL,'\0','2984faec-6c59-436b-9971-d6d1d9d90c51','\0','rexbroo@gmail.com'),('5302fa02-90f1-4dd4-9ef0-6668d3b0df0a',0,'1f272e8a-13ca-4968-843d-b8ffd1c90ba9','ApplicationUser','Bronto@Saurus.com','\0','',NULL,'BRONTO@SAURUS.COM','BRONTO@SAURUS.COM','AQAAAAEAACcQAAAAEEXeIS4dkpa/q7tW1wAafmB9Fps6fevZ/oKRzBGrMsZfqESSGnGF8UloQiP5oMbczw==',NULL,'\0','f602183e-c429-4b96-b6ee-c6f9350a48a5','\0','Bronto@Saurus.com');
...
INSERT INTO `resource` VALUES (1,4,'NULL','NULL','NOAA-NWS-ALERTS-CA1258388FSECFC.WinterStormWarning.125838f803C0CA.EKAWSWEKA.d2e18d2b81b08f7bcd9e6fadde0ff6ddb','NULL','NULL',0,'NULL','NOAA-NWS-ALERTS-CA125838fsecfc.WinterStormWarning.125838f803c0CA.EKAWSWEKA.d2e18d2b81b08f7bcd9e6fadde0ff6db'),(2,4,'NULL','NULL','NOAA-NWS-ALERTS-CA125A9F5E174C.WinterWeatherAdvisory.125AA39AAE60CA.REVWSWREV.58c9bead01ca6732bc88705059f76f46','NULL','NULL',0,'NULL','NOAA-NWS-ALERTS-CA125A9F5E174C.WinterWeatherAdvisory.125AA39AAE60CA.REVWSWREV.58c9bead01ca6732bc88705059f76f46'),(3,4,'NULL','NULL','NOAA-NWS-ALERTS-AK125AA3AA1EB8.FloodAdvisory.125AA3B95FCCAK.AFCFLSAFC.026e2b11e582dbb6bd863dfa37b89739','NULL','NULL',0,'NULL','NOAA-NWS-ALERTS-AK125AA3AA1EB8.FloodAdvisory.125AA3B95FCCAK.AFCFLSAFC.026e2b11e582dbb6bd863dfa37b89739');
...
-- Dump completed on 2018-09-28 13:08:32
